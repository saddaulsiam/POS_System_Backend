...
export const createEmployeeValidator = [
  ...
  body("role").isIn(["OWNER", "ADMIN", "MANAGER", "CASHIER", "STAFF"]).withMessage("Invalid role"),
...
export const updateEmployeeValidator = [
  ...
  body("role").optional().isIn(["OWNER", "ADMIN", "MANAGER", "CASHIER", "STAFF"]).withMessage("Invalid role"),
