...
router
  ...
  .post([authenticateToken, authorizeRoles("OWNER", "ADMIN", "MANAGER"), ...productsValidator.create], createProduct);

router
  .route("/:id")
  .get(authenticateToken, getProductById)
  .put([authenticateToken, authorizeRoles("OWNER", "ADMIN", "MANAGER"), ...productsValidator.update], updateProduct)
  .delete([authenticateToken, authorizeRoles("OWNER", "ADMIN", "MANAGER")], deleteProduct);
