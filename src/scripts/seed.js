...
//     update: {},
//     create: { productId, isActive: true, ...variant },
//   });
// }
...
//   // -------------------------------------------------
//   // 1. Bootstrap dummy owner (required for store)
//   // -------------------------------------------------
...
//   // -------------------------------------------------
//   // 3. Create REAL admin & update store owner
//   // -------------------------------------------------
...
//   // Ensure Snacks category exists for chips
//   categories["Snacks"] = await upsertCategory("Snacks", store.id);
...
//     where: { email: "orders@freshfarm.com" },
//     update: {},
//     create: {
...
//     update: {},
//     create: {
//       name: "Farm Fresh Eggs (12ct)",
//       sku: "EGGS-001",
//       barcode: "1234567890888",
//       description: "A dozen farm fresh eggs",
//       categoryId: categories["Dairy & Eggs"].id,
//       supplierId: supplier.id,
//       purchasePrice: 2.0,
//       sellingPrice: 3.5,
...
//   for (const v of colaVariants) await upsertProductVariant(cola.id, v);

//   // -------------------------------------------------
//   // 9. Products with variants — Chips
//   // -------------------------------------------------
...
//       description: "Delicious crispy chips in different flavors",
...
//   for (const v of chipsVariants) await upsertProductVariant(chips.id, v);
